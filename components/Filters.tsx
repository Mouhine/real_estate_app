...
const Filters = () => {
  ...
  return (
    <section className=" w-[90%] relative py-4 lg:py-0 rounded-md px-4 mx-auto flex flex-wrap space-x-6 items-center border  gap-4 mt-[100px]">
      ...
      <button
        className=" absolute right-0 -top-5 bg-white  border px-5 py-2 focus:border-blue-300 shadow outline-none cursor-pointer  rounded-lg"
        onClick={() => reset()}
      >
        reset
      </button>

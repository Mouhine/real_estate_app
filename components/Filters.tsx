      ...
      <div className="flex items-center justify-between flex-wrap w-full space-y-3 md:space-y-0 ">
        ...
        <div className="relative">
          ...
          {isPriceOpen && (
            <div>
              {purpose === "for-rent" ? (
                <section className="flex z-20 items-center space-x-4  absolute bg-white -bottom-[100px] px-4 py-4 border rounded-xl">
                  <select
                    name=""
                    id=""
                    className={SelectStyle}
        ...
        <div className="col-span-2  space-y-4 relative place-self-center">
          ...
          {isAreaOpen && (
            <section className="z-20 flex items-center space-x-4 -left-[100px] absolute bg-white -bottom-[100px] px-4 py-4 border rounded-xl">
              <select
                name=""
                id=""
                className={SelectStyle}
